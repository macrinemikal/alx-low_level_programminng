 ...
 *
 * Description: Magic numbers are separated by spaces between them.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A pointer to an array containiing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
...
/**
 * print_abi - Prints the ABI verrsion of an ELF header.
...
/**
 * print_entry - Printss entry point of an ELF header.
 ...
 * ELF header at e start of an ELF file.
